/*Verificar se um número é regular:
Um número é dito regular se sua decomposição em fatores 
primos apresenta apenas potências de 2, 3 e 5. Por exemplo, 
o número 60 é um número regular  uma vez que:
60 = 2²×3×5
